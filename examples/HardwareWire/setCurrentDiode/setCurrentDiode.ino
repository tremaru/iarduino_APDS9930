...
//  Задаём ток протекающий через инфракрасный светод чипа:                //  Инициировать датчик можно без проверки: apds.begin(&Wire); Объект основной аппаратной шины I2C (&Wire) можно не указывать: apds.begin(); 
